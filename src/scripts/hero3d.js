// Three.js hero scene: a wireframe "global system" sphere (brass) with orbiting
// rainbow nodes (the FIDIC books) and a drifting particle field. Mouse parallax
// + slow auto-rotation. Lightweight, guarded for reduced-motion / no-canvas.
...
if (canvas && !reduce) {
  ...
  // Core wireframe icosphere (brass)
  ...
  // Inner solid-ish faceted shell (very subtle)
  ...
  // Outer faint ring sphere (blueprint blue)
  ...
  const points = new THREE.Points(
    pGeo,
    new THREE.PointsMaterial({ color: 0xc9a45c, size: 0.035, transparent: true, opacity: 0.6 })
  );
  scene.add(points);
