...
const localized = {
  ru: {
    ...
    toolItems: [
      ...
      ['Калькулятор time-bar (28 / 84 дня)', 'Дата события → крайние сроки notice и detailed claim и риск утраты права. Sub-Clause 20.2.', '/tools/calculators/time-bar'],
  ...
  en: {
    ...
    toolItems: [
      ...
      ['Time-bar calculator (28 / 84 days)', 'Event date → notice and detailed-claim deadlines and time-bar risk. Sub-Clause 20.2.', '/tools/calculators/time-bar'],
  ...
  uz: {
    ...
    toolItems: [
      ...
      ['Time-bar kalkulyatori (28 / 84 kun)', 'Hodisa sanasi → notice va detailed claim muddatlari va huquqni yoʻqotish xavfi. Sub-Clause 20.2.', '/tools/calculators/time-bar'],
